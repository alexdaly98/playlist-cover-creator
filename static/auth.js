...
function displayUserProfile(userProfile) {
    ...
    if (userProfile) {
        ...
        userImage.src = userProfile.images[0]?.url || 'default-profile-image-url'; // Provide a default image URL if no profile image is available
...
const redirectUri = 'https://playlist-cover-creator-888428643041.us-central1.run.app/thumbnail-generator';  // Replace with your app's redirect URI
